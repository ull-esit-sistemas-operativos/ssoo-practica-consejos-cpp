...
```{.bash}
$ g++ -std=c++23 -Wall -Wextra -Wpedantic -o ejemplo ejemplo.cpp
```

Además de las opciones mínimas anteriores, el proyecto [CMake for C++ Best Practices](https://github.com/cpp-best-practices/cmake_template) recomienda activar también las siguientes:
...
* `-Wimplicit-fallthrough`. Activa avisos sobre saltos implícitos de un caso a otro en una sentencia `switch`.
